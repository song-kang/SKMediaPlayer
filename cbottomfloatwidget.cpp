...
CBottomFloatWidget::CBottomFloatWidget(QWidget *parent)
	: QWidget(parent)
{
	Init();
	InitUi();
...
void CBottomFloatWidget::InitSlot()
{
...
void CBottomFloatWidget::mousePressEvent(QMouseEvent *e)
{
	QWidget::mousePressEvent(e);
}

void CBottomFloatWidget::mouseReleaseEvent(QMouseEvent *e)
{
	QWidget::mouseReleaseEvent(e);
}

void CBottomFloatWidget::mouseMoveEvent(QMouseEvent *e)
{
	setCursor(Qt::ArrowCursor);
	QWidget::mouseMoveEvent(e);
}

void CBottomFloatWidget::mouseDoubleClickEvent(QMouseEvent *e)
{
	QWidget::mouseDoubleClickEvent(e);
}

void CBottomFloatWidget::paintEvent(QPaintEvent *e)
{
